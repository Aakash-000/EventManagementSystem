...
import { AppBar, Toolbar, Button, Typography, Box, Paper, MenuList, MenuItem } from '@mui/material';
    ...
    <NavbarStyle position="fixed">
      <NavbarContainer>
        ...
        alignItems: 'center',
          ...
          <NavLink color="inherit" onClick={() => handleSetActive('forHome')} 
          sx = {{borderBottom : isActive.forHome ? '2px solid #2A9D8F' : '0px'}}>
                Home{console.log(isActive)}
          ...
          sx = {{borderBottom : isActive.forExplore ? '2px solid #2A9D8F' : '0px'}}>
          Explore
          </NavLink>
          </StyledNavLink>
          <StyledNavLink to="/loginpage" activeClassName="active">
          <NavLink color="inherit" onClick={() => handleSetActive('forLogin')} 
            sx = {{borderBottom : isActive.forLogin ? '2px solid #2A9D8F' : '0px'}}>
            Login
          </NavLink>
          </StyledNavLink>
          <DropdownContainer onMouseLeave={handleDropdownClose}>
            <NavLink
              ...
              sx = {{borderBottom : isActive.forRegister ? '2px solid #2A9D8F' : '0px'}}
            >
              Register
            </NavLink>
            <DropdownMenu
            ...
            >
              <MenuList>
                ...
                <StyledNavLink to="/registrationpageUO"
                onClick={() => handleSetActive('forRegister')} 
                ...
                <DropdownItem onClick={handleDropdownClose}>
                <StyledNavLink to="/registrationpageD"
                onClick={() => handleSetActive('forRegister')} 
                activeClassName="active">
                    Dealer
                  </StyledNavLink>
