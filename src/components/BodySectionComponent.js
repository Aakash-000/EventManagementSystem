...
const BodySectionComponent = () => {
  ...
  return (
    <Box sx={bodySectionStyles}>
      <Typography variant="h6" sx={{fontFamily:'Helvetica,sans-serif',textAlign:'center'}} gutterBottom>
      ...
      {blogItems.map((item, index) => (
        ...
        >
          <Typography variant="h6" sx={{fontFamily:'Helvetica,sans-serif',fontWeight:'500'}}>{item.title}</Typography>
          <Typography variant="body1" sx={{fontSize:'13px',fontFamily:'Oxygen,Helvetica,sans-serif',fontWeight:'500'}}
